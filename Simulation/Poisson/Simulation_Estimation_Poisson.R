...
if(continue){
  ...
  estim_moments <- read.csv(file = paste0("Results/pois_estim_moments_", tau, "_", phi, "_",
  ...
  estim_moments <- matrix(NA, nrow = n_sim, ncol = 3,
...
for(i in inds_to_run){
  ...
  if(i%%10 == 0 | i < 5){
    ...
    # write.csv(sim_data, file = paste0("Results/pois_sim_", tau, "_", phi,
    #                                   "_", kappa, "_", lgt, ".csv"))
    # write.csv(estim, file = paste0("Results/pois_estim_", tau, "_", phi,
    #                                "_", kappa, "_", lgt, ".csv"))
    # write.csv(ses, file = paste0("Results/pois_ses_", tau, "_", phi,
    #                              "_", kappa, "_", lgt, ".csv"))
    write.csv(estim_moments, file = paste0("Results/pois_estim_moments_", tau, "_", phi,
                                           "_", kappa, "_", lgt, ".csv"))
  }
}
#   }
