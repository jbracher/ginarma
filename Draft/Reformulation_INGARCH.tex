...
As $\{X_t\}$ is ergodic, the limits\todo{CW: Add example with computation times; distinction of h-step ahead distributions and using matrix inverse; possibly check setting like $\alpha = 0.2, \beta = 0.75$.}
$$
...
\begin{align*}
\lambda_1 = \mu_\psi\mathbb{E}(N_1 \ \mid \ X_0) & = \mu_\psi\tau + \mu_\psi(1 - \beta)\kappa X_0 + \mu_\psi(1 - \beta)\eta\\ % \lambda_1 = \tau(1 - \beta) + (1 - \beta)\kappa X_0 + \beta\left(\tau + \frac{1 - \beta}{\beta} \times \eta \right),\\
