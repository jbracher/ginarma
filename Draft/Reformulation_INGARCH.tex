...
\item Given $S_t$, $(R_t, H_t, X_t, L_t)$ is independent of all $\juv_u, R_u, H_u, X_u, L_u, u < t$.
...
$$
to the discrete Markov chain $\{S_t\}$. Subsequently one can then compute an approximatin of the limiting stationary distribution of $X_t$ as
$$
