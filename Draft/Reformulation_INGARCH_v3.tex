...
\begin{figure}
\center
\includegraphics[scale=0.85]{figure/flowchart_ingarch_poisson_SEIR.pdf}
...
$$
C_t^{(i)} \mid X_t \stackrel{\text{ind}}{\sim} \text{Pois}(\beta^{i - 1}[1 - \beta]\kappa X_t). % ; \ \ C_t^{(i)} \perp C_t^{(j)} \mid X_t, i \neq j.
$$
