## Script generating the result table of fitting the Poisson INARMA(2, 1) using
...
write(
  print(
    xtable(to_print),
        ...
        hline.after = NULL),
  file = paste0("AR_approximation_example/Tables/AR_approx_inarma21_sc", s, "pois.tex")
)
